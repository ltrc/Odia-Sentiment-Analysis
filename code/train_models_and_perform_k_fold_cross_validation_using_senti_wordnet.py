"""Create vectorizers and train models, and perform 5-Fold cross validation with an additional feature of senti wordnet lexicon."""
...
def main():
    ...
    all_tf_idf_vectors_with_senti_wordnet = hstack([all_tf_idf_vectors, pos_and_neg_sparse_matrix])
